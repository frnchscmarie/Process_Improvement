...
CREATE TABLE `ot` (
  ...
  `rate_weekends` varchar(50) NOT NULL,
  `rate_weekdays` varchar(50) NOT NULL,
...
INSERT INTO `ot` (`id`, `employeeID`, `date_of_filing`, `auto_OT`, `aot_from`, `aot_to`, `rate_weekends`, `rate_weekdays`, `hours_weekends`, `minutes_weekends`, `hours_weekdays`, `minutes_weekdays`, `task`, `authorized_by`, `status`, `remarks`) VALUES
(1, '02', '2019-02-01', '1231', '03:02', '16:12', '123', '0', '123123', '123131', '', '', '12231', '', '', ''),
(2, '02', '2019-02-01', 'xcvxcvcxv', '03:42', '02:34', 'xcvxcvxcvxcv', '0', '3454545', '3534535', '', '', '34535', '', '', ''),
(3, '02', '2019-02-01', 'xbattalion', '15:43', '14:43', 'dsfsdfdsfsd', '0', '234567890', '23456789', '', '', 'zxczxczxasda', '', '', '');
